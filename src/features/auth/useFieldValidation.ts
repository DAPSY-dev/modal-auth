...
export function useFieldValidation<Field extends string>(rules: Record<Field, () => string | undefined>) {
  ...
  function validate(form: HTMLFormElement) {
    setSubmitted(true);
    const invalidField = (Object.keys(rules) as Field[]).find((name) => rules[name]());
